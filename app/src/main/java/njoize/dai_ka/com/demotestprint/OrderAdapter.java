...
public class OrderAdapter extends RecyclerView.Adapter<OrderAdapter.OrderViewHolder>{
    ...
    public OrderAdapter(Context context, ArrayList<String> nameFoodStringArrayList, ArrayList<String> amountStringArrayList, ArrayList<String> priceStringArrayList, OnClickImage onClickItem) {
...
//        });
    ...
    public class OrderViewHolder extends RecyclerView.ViewHolder {
        ...
        public OrderViewHolder(@NonNull View itemView) {
            ...
            decImageView = itemView.findViewById(R.id.imvDecrese);
